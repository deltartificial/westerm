...
use westerm_terminal::event::{Event, EventListener};
use westerm_terminal::grid::{Dimensions, Grid};
use westerm_terminal::index::{Column, Line};
use westerm_terminal::term::cell::Cell;
use westerm_terminal::term::test::TermSize;
use westerm_terminal::term::{Config, Term};
use westerm_terminal::vte::ansi;
...
fn ref_test(dir: &Path) {
    let recording = read_u8(dir.join("westerm.recording"));
