//! Westerm - The GPU Enhanced Terminal.
...
/// Temporary files stored for Westerm.
///
...
/// Run main Westerm entrypoint.
///
/// Creates a window, the terminal state, PTY, I/O event loop, input processor,
/// config change monitor, and runs the main display loop.
fn westerm(mut options: Options) -> Result<(), Box<dyn Error>> {
