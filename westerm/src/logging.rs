...
pub const LOG_TARGET_IPC_CONFIG: &str = "westerm_log_window_config";

/// Name for the environment variable containing the log file's path.
const ALACRITTY_LOG_ENV: &str = "ALACRITTY_LOG";

/// Logging target for config error messages.
pub const LOG_TARGET_CONFIG: &str = "westerm_config_derive";

/// Logging target for winit events.
pub const LOG_TARGET_WINIT: &str = "westerm_winit_event";
...
/// List of targets which will be logged by Westerm.
const ALLOWED_TARGETS: &[&str] = &[
    LOG_TARGET_IPC_CONFIG,
    LOG_TARGET_CONFIG,
    LOG_TARGET_WINIT,
    "westerm_config_derive",
    "westerm_terminal",
    "westerm",
    "crossfont",
];
...
impl OnDemandLogFile {
    fn new() -> Self {
        ...
        path.push(format!("Westerm-{}.log", process::id()));
