...
use westerm_terminal::event::{Event as TerminalEvent, EventListener, Notify};
use westerm_terminal::event_loop::Notifier;
use westerm_terminal::grid::{BidirectionalIterator, Dimensions, Scroll};
use westerm_terminal::index::{Boundary, Column, Direction, Line, Point, Side};
use westerm_terminal::selection::{Selection, SelectionType};
use westerm_terminal::term::cell::Flags;
use westerm_terminal::term::search::{Match, RegexSearch};
use westerm_terminal::term::{self, ClipboardType, Term, TermMode};
use westerm_terminal::vte::ansi::NamedColor;
...
impl<'a, N: Notify + 'a, T: EventListener> input::ActionContext<T> for ActionContext<'a, N, T> {
    ...
    fn spawn_new_instance(&mut self) {
        ...
        let westerm = env_args.next().unwrap();

        let mut args: Vec<String> = Vec::new();

        // Reuse the arguments passed to Westerm for the new instance.
        ...
        self.spawn_daemon(&westerm, &args);
    }
