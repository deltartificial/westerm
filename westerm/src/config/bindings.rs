...
use westerm_terminal::term::TermMode;
...
pub enum Action {
    ...
    /// Hide the Westerm window.
    Hide,

    /// Hide all windows other than Westerm on macOS.
    HideOtherApplications,

    /// Minimize the Westerm window.
    Minimize,
    ...
    /// Spawn a new instance of Westerm.
    SpawnNewInstance,
