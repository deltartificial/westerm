...
use westerm_terminal::term::Config as TermConfig;
use westerm_terminal::term::search::RegexSearch;
use westerm_terminal::tty::{Options as PtyOptions, Shell};
...
pub struct UiConfig {
    ...
    /// Config for the westerm_terminal itself.
