...
use westerm_terminal::grid::{BidirectionalIterator, Dimensions};
use westerm_terminal::index::{Boundary, Column, Direction, Line, Point};
use westerm_terminal::term::cell::Hyperlink;
use westerm_terminal::term::search::{Match, RegexIter, RegexSearch};
...
#[cfg(test)]
mod tests {
    use westerm_terminal::index::{Column, Line};
    use westerm_terminal::term::test::mock_term;
    use westerm_terminal::vte::ansi::Handler;
